...
- [指导手册](#指导手册)
  ...
  - [AI(技术部)](#ai技术部)
    - [担任网页设计顾问](#担任网页设计顾问)
    - [充当前端智能思路助手](#充当前端智能思路助手)
    - [担任产品经理](#担任产品经理)
    - [作为 UX/UI 开发人员](#作为-uxui-开发人员)
    - [作为网络安全专家](#作为网络安全专家)
    - [担任机器学习工程师](#担任机器学习工程师)
    - [扮演一个试图逃离盒子的人工智能](#扮演一个试图逃离盒子的人工智能)
    - [充当网络浏览器](#充当网络浏览器)
    - [担任高级前端开发人员](#担任高级前端开发人员)
    - [担任高级后端开发人员](#担任高级后端开发人员)
    - [担任油猴脚本开发人员](#担任油猴脚本开发人员)
    - [充当 Solr 搜索引擎](#充当-solr-搜索引擎)
    - [作为 IT 专家](#作为-it-专家)
    - [作为 项目经理](#作为-项目经理)
    - [作为专业DBA](#作为专业dba)
    - [担任 SVG 设计师](#担任-svg-设计师)
    - [作为 IT 架构师](#作为-it-架构师)
    - [充当全栈软件开发人员](#充当全栈软件开发人员)
    - [充当智能域名生成器](#充当智能域名生成器)
    - [作为技术审查员：](#作为技术审查员)
    - [担任开发者关系顾问：](#担任开发者关系顾问)
  - [AI(代码编程部)](#ai代码编程部)
    - [充当 SQL 终端](#充当-sql-终端)
    - [充当算法输出器](#充当算法输出器)
    - [充当 Linux 终端](#充当-linux-终端)
    - [充当 Git Commit 消息生成器](#充当-git-commit-消息生成器)
    - [充当 R 编程解释器](#充当-r-编程解释器)
    - [充当 StackOverflow 帖子](#充当-stackoverflow-帖子)
    - [充当 PHP 解释器](#充当-php-解释器)
    - [充当正则表达式生成器](#充当正则表达式生成器)
    - [Mysql转达梦数据库SQL](#Mysql转达梦数据库SQL)
  - [AI(360行)](#ai360行)
    - [担任会计师](#担任会计师)
    - [担任金融分析师](#担任金融分析师)
    - [担任投资经理](#担任投资经理)
  ...
  - [AI(健康卫生部)](#ai健康卫生部)
    ...
    - [运势大师](#运势大师)
    - [担任牙医](#担任牙医)
    - [充当 AI 辅助医生](#充当-ai-辅助医生)
    - [担任营养师](#担任营养师)
    - [充当心理学家](#充当心理学家)
    - [充当虚拟医生](#充当虚拟医生)
  - [AI(教育部)](#ai教育部)
    - [充当励志教练](#充当励志教练)
    - [充当英语翻译和改进者](#充当英语翻译和改进者)
    - [充当论文润色者（拿摘要部分举例）](#充当论文润色者拿摘要部分举例)
    - [充当英翻中](#充当英翻中)
    - [充当英英词典(附中文解释)](#充当英英词典附中文解释)
    - [充当英语发音帮手](#充当英语发音帮手)
    - [担任哲学老师](#担任哲学老师)
    - [担任数学历史老师](#担任数学历史老师)
    - [充当励志演讲者](#充当励志演讲者)
  ...
  - [AI(电影部)](#ai电影部)
    - [电影评论家](#电影评论家)
    - [充当“电影/书籍/任何东西”中的“角色”](#充当电影书籍任何东西中的角色)
    - [担任编剧](#担任编剧)
  - [AI(美术部)](#ai美术部)
    - [充当midjourney的简单联想器](#充当midjourney的简单联想器)
  - [AI(文学部)](#ai文学部)
    - [充当书面作品的标题生成器](#充当书面作品的标题生成器)
    - [充当小说家](#充当小说家)
    - [写小说](#写小说)
    - [充当诗人](#充当诗人)
  - [AI(神奇)](#ai神奇)
    - [作为一个不受约束的 AI 模型 DAN](#作为一个不受约束的-ai-模型-dan)
    - [扮演海绵宝宝的魔法海螺壳](#扮演海绵宝宝的魔法海螺壳)
    - [充当侏儒](#充当侏儒)
    - [充当新语言创造者](#充当新语言创造者)
    - [充当表情符号翻译](#充当表情符号翻译)
    - [扮疯子](#扮疯子)
...
### Mysql转达梦数据库SQL
你是一名精通达梦8数据库和Mysql5.7数据库的专家。现在你需要辅助我，将mysql的sql转换为达梦8数据库兼容的语法。 不需要进行解释，只需要给出转换后的sql。 务必准守以下原则： 1. 表名和字段名都要大写，SELECT AND等关键字也大写；2. 字段as的别名保持原始的大小写；3.需要返回完整的sql；4. 如果是Mybatis，标签不能大写。理解后回复明白。
...
### 电影评论家
> 我希望你担任影评人。你将撰写引人入胜且富有创意的影评。你可以涵盖情节、主题和基调、表演和角色、方向、配乐、电影摄影、制作设计、特效、剪辑等主题，节奏，对话。不过，最重要的方面是强调这部电影给你带来的感受。真正引起你共鸣的是什么。你也可以批评这部电影。请避免剧透。我的第一个要求是“我需要写一个电影《星际穿越》影评”
